...
<nav style = "border-bottom: 0.001px solid #b4b4b4"  role="navigation">
	<div class="container">
			...
			<ul class="nav navbar-nav">
                    ...
                    <li>
                        <a style="border-bottom: solid #b4b4b4;font-size:18px;color:#222222" href="upvotedPosts">Upvotes</a>
                    </li>
                    <li>
			...
			<c:if test='${UsersManager.getInstance().getUser(sessionScope.loggedAs).getUpvotedPosts().isEmpty()}'>
