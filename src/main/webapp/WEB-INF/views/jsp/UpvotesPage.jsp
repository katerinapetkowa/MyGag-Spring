	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				...
				<c:if
					test='${UsersManager.getInstance().getUser(sessionScope.loggedAs).getUpvotedPosts().isEmpty()}'>
					<h3 class="page-header">No upvoted posts</h3>
				</c:if>
				<c:forEach var='post'
					items='${UsersManager.getInstance().getUser(sessionScope.loggedAs).getUpvotedPosts().values()}'>
