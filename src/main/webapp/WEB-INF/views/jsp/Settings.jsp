					...
					<div>
						...
						<div style="margin-left: 25%; padding: 1px 16px; height: 1000px;">
							...
							<form action="changeSettings" method="post"
								enctype="multipart/form-data">
								<small style="color: #000000;"><b>Avatar</b> </small> <img
									class="img-responsive"
									src="profilePicture?username=${UsersManager.getInstance().getUser(sessionScope.loggedAs).getUsername()}"
									alt="" width="100"> <br> <input type="file"
									name="profilePicture" accept="image/*" autocomplete="off">

								<br> <br> <small style="color: #000000"><b>Your
										name</b> </small> <input id="username" name="username" type="hidden"
									value="<c:out value="${sessionScope.loggedAs}"></c:out>"
									size="30" required> <input type="text" id="name"
									name="name"
									...
									onfocus="this.style.borderColor = '#1ab188'"
									onfocusout="this.style.borderColor = '#a0b3b0'" maxlength="40"
									value="${UsersManager.getInstance().getUser(sessionScope.loggedAs).getEmail()}"
									required autocomplete="off"> <br> <br> <small
									style="color: #000000"><b>Tell people who you are</b>
								</small>
								<textarea name="description" id="description"
									style="width: 100%; padding: 12px 20px; margin: 2px 0; display: inline-block; border: 1px solid #ccc; box-sizing: border-box; background-color: #ffffff; height: 100px"
									onfocus="this.style.borderColor = '#1ab188'"
									onfocusout="this.style.borderColor = '#a0b3b0'" maxlength="120"
							...
							<br> <a style="text-decoration: none; color: black"
								...
								onmouseout="this.style.color = 'black'" href="deleteAccount">
								Delete account</a>
						</div>
					</div>
