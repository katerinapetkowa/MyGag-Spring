...
<!--  </form> -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Blog Entries Column -->
            <div class="col-md-8">
				<c:if test='${PostsManager.getInstance().getFreshPostsByCategory("Funny").isEmpty()}'>
                <h2 style = "font-family:sans-serif" class="page-header">
                   No posts for this category   
                </h2>
                </c:if>
                
                <c:forEach var = "post" items='${PostsManager.getInstance().getFreshPostsByCategory("Funny").values()}'>
