	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<h4>
					<b>Search results for "<c:out value="${requestScope.title}"></c:out>"
					</b>
				</h4>
				<c:if
					test='${PostsManager.getInstance().searchPosts(requestScope.title).isEmpty()}'>
					<h4>No results</h4>
				</c:if>
				<c:forEach var="post"
					items='${PostsManager.getInstance().searchPosts(requestScope.title).values()}'>
					<!-- First Blog Post -->
