...
<body>
				...
				<form id="registerForm" class="signup" accept = "image/*" onsubmit="return Validate(this)"
					...
					<div class="field-wrap">
						<label> Password<span class="req">*</span>
							...
							onfocus="this.style.borderColor = '#1ab188'"
							onfocusout="this.style.borderColor = '#a0b3b0' "
							style="font-size: 22px; display: block; width: 100%; height: 100%; padding: 5px 10px; background: none; color: #ffffff; border-radius: 0; background-image: none; border: 1px solid #a0b3b0;"
							required autocomplete="off" />
					</div>
		...
		<div class="form"
			...
			<div class="tab-content">
				...
				<form action="createpost" accept = "image/*" onsubmit="return Validate(this)" method="post"
					...
					<div class="field-wrap">
						<label style="font-size: 19px"> Title<span class="req">*</span>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<c:if
					test='${PostsManager.getInstance().getFreshPostsByCategory("Sport").isEmpty()}'>
					<h2 style="font-family: sans-serif" class="page-header">No
						posts for this category</h2>
				</c:if>

				<c:forEach var="post"
					items='${PostsManager.getInstance().getFreshPostsByCategory("Sport").values()}'>
...
function showMesage(results){
	if(results == 'success'){
		...
		$('#message2').html("<font size = '3'color='#c62115'>Passwords don't match</font>")
	}
}
